---
name: create-tasks
description: Create an Agent OS tasks list from an approved feature spec. MUST BE USED after spec approval to generate implementation tasks.
...
<execution_flow>
  IF user_confirms_yes:
    REFERENCE: Use execute-tasks agent
