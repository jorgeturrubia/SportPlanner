...
namespace SportPlanner.Migrations
{
    ...
    [Migration("20250923213155_CreateGenderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportPlanner.Models.Masters.Gender", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportPlanner.Models.Masters.ObjectiveCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ObjectiveCategories");
                });

            modelBuilder.Entity("SportPlanner.Models.Masters.ObjectivePriority", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ObjectivePriorities");
                });

            modelBuilder.Entity("SportPlanner.Models.Masters.ObjectiveScope", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ObjectiveScopes");
                });

            modelBuilder.Entity("SportPlanner.Models.Masters.ObjectiveStatus", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportPlanner.Models.Masters.ObjectiveSubcategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("ObjectiveCategoryId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ObjectiveSubcategories");
                });
            ...
            modelBuilder.Entity("SportPlanner.Models.Masters.UserRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportPlanner.Models.Objective", b =>
                {
                    ...
                    b.Property<int>("ObjectiveSubcategoryId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("SportPlanner.Models.ObjectiveExercise", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SportPlanner.Models.Masters.ObjectiveSubcategory", b =>
                {
                    b.HasOne("SportPlanner.Models.Masters.ObjectiveCategory", "ObjectiveCategory")
                        .WithMany("Subcategories")
                        .HasForeignKey("ObjectiveCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ObjectiveCategory");
                });
            ...
            modelBuilder.Entity("SportPlanner.Models.Objective", b =>
                {
                    ...
                    b.HasOne("SportPlanner.Models.Masters.ObjectiveSubcategory", "ObjectiveSubcategory")
                        .WithMany("Objectives")
                    ...
                    b.Navigation("ObjectiveSubcategory");
            ...
            modelBuilder.Entity("SportPlanner.Models.ObjectiveExercise", b =>
                {
                    b.HasOne("SportPlanner.Models.CustomExercise", "Exercise")
                        .WithMany()
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SportPlanner.Models.Objective", "Objective")
                        .WithMany("Exercises")
            ...
            modelBuilder.Entity("SportPlanner.Models.Planning", b =>
                {
                    ...
                    b.HasOne("SportPlanner.Models.Masters.Level", null)
                        .WithMany()
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("SportPlanner.Models.User", b =>
                {
                    ...
                    b.HasOne("SportPlanner.Models.Masters.UserRole", "UserRole")
                        .WithMany()
