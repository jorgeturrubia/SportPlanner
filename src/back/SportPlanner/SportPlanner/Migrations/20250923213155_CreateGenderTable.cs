    ...
    public partial class CreateGenderTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectiveCategories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectivePriorities", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "ObjectiveScopes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectiveScopes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ObjectiveCategoryId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectiveSubcategories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObjectiveSubcategories_ObjectiveCategories_ObjectiveCategor~",
                        column: x => x.ObjectiveCategoryId,
                        principalTable: "ObjectiveCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseCategoryId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Itineraries_Levels_LevelId",
                        column: x => x.LevelId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectiveExercise", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ObjectiveExercise_CustomExercises_ExerciseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    ObjectiveCategoryId = table.Column<int>(type: "integer", nullable: false),
                    ObjectiveSubcategoryId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Objectives_ObjectiveCategories_ObjectiveCategoryId",
                        column: x => x.ObjectiveCategoryId,
                        principalTable: "ObjectiveCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Objectives_ObjectiveSubcategories_ObjectiveSubcategoryId",
                        column: x => x.ObjectiveSubcategoryId,
                        principalTable: "ObjectiveSubcategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SportGenderId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Plannings_Levels_LevelId",
                        column: x => x.LevelId,
                        principalTable: "Levels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjectiveCategories_Name",
                table: "ObjectiveCategories",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ObjectiveExercise_ExerciseId",
                table: "ObjectiveExercise",
                column: "ExerciseId");

            migrationBuilder.CreateIndex(
                name: "IX_ObjectiveExercise_ObjectiveId",
                table: "ObjectiveExercise",
                column: "ObjectiveId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjectiveSubcategories_ObjectiveCategoryId_Name",
                table: "ObjectiveSubcategories",
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_ObjectiveExercise_Objectives_ObjectiveId",
                table: "ObjectiveExercise",
                column: "ObjectiveId",
